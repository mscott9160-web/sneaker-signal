...
- `SUPABASE_SERVICE_ROLE_KEY` (platform-provided server variable; never add this as a custom secret)
...
- `SUPABASE_SERVICE_ROLE_KEY` (provided automatically to the Edge Function)
- `RESEND_API_KEY`
- `RESEND_FROM_EMAIL`
...
npx supabase secrets set RESEND_API_KEY=... RESEND_FROM_EMAIL=... REMINDER_FUNCTION_SECRET=... APP_URL=https://sneaker-signal.example
